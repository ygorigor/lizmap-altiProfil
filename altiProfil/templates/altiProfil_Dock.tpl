...
<div class="altiProfil">
  <h3>
    <span class="title">
      <button id= "altiProfil-stop" class="btn-altiProfil btn-close" title="{@view~map.toolbar.content.stop@}" onclick="document.querySelector('#button-altiProfil').click();"></button>
